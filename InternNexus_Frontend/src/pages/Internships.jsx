  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto py-8 px-6">
        {/* Header */}
        <div className="mb-8">
          <h2 style={{fontFamily: 'Fraunces, serif'}} className="text-3xl font-bold text-gray-900">
            {user?.role === "company" ? "Your Internship Posts" : "Find Internships"}
          </h2>
          <p className="text-gray-500 mt-1 text-sm">
            {user?.role === "company" ? "Manage your posted internships" : `${internships.length} opportunities available`}
          </p>
        </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        ...
                        <span className="bg-green-50 text-green-700 px-3 py-1 rounded-full text-xs font-medium">
                          ₹{parseInt(intern.stipend).toLocaleString()}/month
                        </span>
                  ...
                  <div className="flex-shrink-0">
                    ...
                    {user?.role === "company" && (
                      <button
                        ...
                        className="px-4 py-2 rounded-xl text-sm font-medium text-red-600 border border-red-200 hover:bg-red-50 transition"
                      >
                        Delete
                      </button>
                    )}
